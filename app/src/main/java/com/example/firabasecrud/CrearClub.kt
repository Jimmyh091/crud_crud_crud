...
class CrearClub : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var lista_clubs = Util.obtenerListaCLubs(database, this)
        botonCrear.setOnClickListener {
            ...
            if (nombre.text.isEmpty() || ciudad.text.isEmpty()
                ...
                GlobalScope.launch(Dispatchers.IO) {
                    ...
                    var nombreArchivo = ""
                    val inputStream = contentResolver.openInputStream(url_escudo!!)
                    val aux = contentResolver.query(url_escudo!!, null, null, null, null)
                    aux.use {
                        if (it!!.moveToFirst()) {
                    ...
                    mimeType = contentResolver.getType(url_escudo!!).toString()
